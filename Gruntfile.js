...
module.exports = function(grunt) {
    ...
    config.copy = {
        lib: {
            files: [
                {src: 'build/lib.js', dest: 'target/www/lib.js'}
            ]
        },
        jsdeps: {
            files: [
        ...
        resources: {
            files: [
                {expand: true, cwd: 'src/', src:'rsc/**/*', dest: 'target/www/'}
            ]
        },
        advancedjs: {
            options: {
            ...
            files: [
                {src: 'build/compiled.js', dest: 'target/www/compiled.js'}
            ]
        }
    };
    ...
    config.symlink = {
        all: {
            files: [
                ...
                { src: 'build/deps.js', dest: 'target/www/deps.js' },
                { expand: true, cwd: 'closure-library', src: ['third_party/'], dest: 'target/www/'}
            ]
        }
    };
